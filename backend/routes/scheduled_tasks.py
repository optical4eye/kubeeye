...
from .main import ScheduledTaskCreate
...
async def get_scheduled_tasks():
    """Get scheduled tasks"""
    try:
        from utils.schedule_manager import load_schedules
...
async def create_scheduled_task(task: ScheduledTaskCreate):
    ...
    try:
        from utils.schedule_manager import ScheduleTask, add_schedule
        import time
...
async def remove_scheduled_task(task_id: str):
    ...
    try:
        from utils.schedule_manager import delete_schedule
...
async def run_scheduled_task(task_id: str):
    """Run scheduled task"""
    try:
        from utils.schedule_manager import run_inspection, update_task_status
...
async def update_scheduled_task(task_id: str, task: ScheduledTaskCreate):
    ...
    try:
        ...
        if add_schedule(updated_task):
            ...
            from utils.schedule_manager import schedule_tasks
