...
Для обеспечения реального времени коммуникации внедрен WebSocket клиент на основе библиотеки `ws`. Это позволяет мгновенное обновление пользовательского интерфейса при изменении состояния задач, инспекций и других асинхронных операций, значительно улучшая пользовательский опыт и снижая нагрузку на сервер по сравнению с традиционным polling. Замена `useTaskPolling` на `useTaskWebSocket` обеспечивает более эффективную и responsive систему мониторинга.
